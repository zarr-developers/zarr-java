...
public interface ArrayBytesCodec extends Codec {
    ...
    ByteBuffer encode(Array chunkArray, ArrayMetadata.CoreArrayMetadata arrayMetadata) throws ZarrException;

    Array decode(ByteBuffer chunkBytes, ArrayMetadata.CoreArrayMetadata arrayMetadata) throws ZarrException;
