...
public final class MultiscaleImage extends OmeV3Group implements MultiscalesMetadataImage<MultiscalesEntry> {
    ...
    public void createScaleLevel(
        ...
        for (CoordinateTransformation ct : coordinateTransformations) {
            ...
            String rawPath = null;
            if (ct instanceof dev.zarr.zarrjava.ome.metadata.transform.ScaleCoordinateTransformation) {
                dev.zarr.zarrjava.ome.metadata.transform.ScaleCoordinateTransformation t =
                        (dev.zarr.zarrjava.ome.metadata.transform.ScaleCoordinateTransformation) ct;
                scale = t.scale;
                rawPath = t.path;
            } else if (ct instanceof dev.zarr.zarrjava.ome.metadata.transform.TranslationCoordinateTransformation) {
                dev.zarr.zarrjava.ome.metadata.transform.TranslationCoordinateTransformation t =
                        (dev.zarr.zarrjava.ome.metadata.transform.TranslationCoordinateTransformation) ct;
                translation = t.translation;
                rawPath = t.path;
            } else if (ct instanceof dev.zarr.zarrjava.ome.metadata.transform.IdentityCoordinateTransformation) {
                dev.zarr.zarrjava.ome.metadata.transform.IdentityCoordinateTransformation t =
                        (dev.zarr.zarrjava.ome.metadata.transform.IdentityCoordinateTransformation) ct;
                rawPath = t.path;
            } else if (ct instanceof dev.zarr.zarrjava.ome.metadata.transform.GenericCoordinateTransformation) {
                Map<String, Object> raw = ((dev.zarr.zarrjava.ome.metadata.transform.GenericCoordinateTransformation) ct).raw;
                ...
                if ("sequence".equals(type)) {
                    v06Transforms.add(new dev.zarr.zarrjava.ome.v0_6.metadata.transform.SequenceCoordinateTransformation(
                            null, null, null, castV06TransformList(raw.get("transformations"))));
                    continue;
                }
                if ("mapAxis".equals(type)) {
                    v06Transforms.add(new dev.zarr.zarrjava.ome.v0_6.metadata.transform.MapAxisCoordinateTransformation(
                            null, null, null, castIntList(raw.get("mapAxis")), castV06Transform(raw.get("transformation"))));
                    continue;
                }
                if ("affine".equals(type)) {
                    v06Transforms.add(new dev.zarr.zarrjava.ome.v0_6.metadata.transform.AffineCoordinateTransformation(
                            null, null, null, castMatrix(raw.get("affine")), rawPath));
                    continue;
                }
                if ("rotation".equals(type)) {
                    v06Transforms.add(new dev.zarr.zarrjava.ome.v0_6.metadata.transform.RotationCoordinateTransformation(
                            null, null, null, castMatrix(raw.get("rotation")), rawPath));
                    continue;
                }
                if ("displacements".equals(type)) {
                    v06Transforms.add(new dev.zarr.zarrjava.ome.v0_6.metadata.transform.DisplacementsCoordinateTransformation(
                            null, null, null, rawPath));
                    continue;
                }
                if ("coordinates".equals(type)) {
                    v06Transforms.add(new dev.zarr.zarrjava.ome.v0_6.metadata.transform.CoordinatesCoordinateTransformation(
                            null, null, null, rawPath));
                    continue;
                }
                if ("bijection".equals(type)) {
                    v06Transforms.add(new dev.zarr.zarrjava.ome.v0_6.metadata.transform.BijectionCoordinateTransformation(
                            null, null, null, castV06Transform(raw.get("forward")), castV06Transform(raw.get("inverse"))));
                    continue;
                }
                if ("byDimension".equals(type)) {
                    v06Transforms.add(new dev.zarr.zarrjava.ome.v0_6.metadata.transform.ByDimensionCoordinateTransformation(
                            null, null, null, castByDimensionTransformList(raw.get("transformations"))));
                    continue;
                }
            }
            if ("scale".equals(type)) {
                v06Transforms.add(new dev.zarr.zarrjava.ome.v0_6.metadata.transform.ScaleCoordinateTransformation(
                        null, null, null, scale, rawPath));
            } else if ("translation".equals(type)) {
                v06Transforms.add(new dev.zarr.zarrjava.ome.v0_6.metadata.transform.TranslationCoordinateTransformation(
                        null, null, null, translation, rawPath));
            } else if ("identity".equals(type)) {
                v06Transforms.add(new dev.zarr.zarrjava.ome.v0_6.metadata.transform.IdentityCoordinateTransformation(
                        null, null, null, rawPath));
            } else {
                dev.zarr.zarrjava.ome.v0_6.metadata.transform.GenericCoordinateTransformation generic =
                        new dev.zarr.zarrjava.ome.v0_6.metadata.transform.GenericCoordinateTransformation(type, null, null, null);
    ...
    private static dev.zarr.zarrjava.ome.v0_6.metadata.transform.CoordinateTransformation castV06Transform(Object raw) {
        if (raw instanceof dev.zarr.zarrjava.ome.metadata.transform.CoordinateTransformation) {
            dev.zarr.zarrjava.ome.metadata.transform.CoordinateTransformation core =
                    (dev.zarr.zarrjava.ome.metadata.transform.CoordinateTransformation) raw;
            if (core instanceof dev.zarr.zarrjava.ome.metadata.transform.ScaleCoordinateTransformation) {
                dev.zarr.zarrjava.ome.metadata.transform.ScaleCoordinateTransformation t =
                        (dev.zarr.zarrjava.ome.metadata.transform.ScaleCoordinateTransformation) core;
                return new dev.zarr.zarrjava.ome.v0_6.metadata.transform.ScaleCoordinateTransformation(
                        null, null, null, t.scale, t.path);
            }
            if (core instanceof dev.zarr.zarrjava.ome.metadata.transform.TranslationCoordinateTransformation) {
                dev.zarr.zarrjava.ome.metadata.transform.TranslationCoordinateTransformation t =
                        (dev.zarr.zarrjava.ome.metadata.transform.TranslationCoordinateTransformation) core;
                return new dev.zarr.zarrjava.ome.v0_6.metadata.transform.TranslationCoordinateTransformation(
                        null, null, null, t.translation, t.path);
            }
            if (core instanceof dev.zarr.zarrjava.ome.metadata.transform.IdentityCoordinateTransformation) {
                dev.zarr.zarrjava.ome.metadata.transform.IdentityCoordinateTransformation t =
                        (dev.zarr.zarrjava.ome.metadata.transform.IdentityCoordinateTransformation) core;
                return new dev.zarr.zarrjava.ome.v0_6.metadata.transform.IdentityCoordinateTransformation(
    ...
    private static List<dev.zarr.zarrjava.ome.v0_6.metadata.transform.CoordinateTransformation> castV06TransformList(Object raw) {
        if (!(raw instanceof List)) {
            return null;
        }
        List<dev.zarr.zarrjava.ome.v0_6.metadata.transform.CoordinateTransformation> out = new ArrayList<>();
        for (Object item : (List<?>) raw) {
            dev.zarr.zarrjava.ome.v0_6.metadata.transform.CoordinateTransformation cast = castV06Transform(item);
            if (cast != null) {
                out.add(cast);
            }
        }
    ...
    private static List<dev.zarr.zarrjava.ome.v0_6.metadata.transform.ByDimensionCoordinateTransformation.ByDimensionTransformation> castByDimensionTransformList(Object raw) {
        if (!(raw instanceof List)) {
            return null;
        }
        List<dev.zarr.zarrjava.ome.v0_6.metadata.transform.ByDimensionCoordinateTransformation.ByDimensionTransformation> out =
                new ArrayList<>();
        for (Object item : (List<?>) raw) {
            ...
            Map<?, ?> map = (Map<?, ?>) item;
            out.add(new dev.zarr.zarrjava.ome.v0_6.metadata.transform.ByDimensionCoordinateTransformation.ByDimensionTransformation(
