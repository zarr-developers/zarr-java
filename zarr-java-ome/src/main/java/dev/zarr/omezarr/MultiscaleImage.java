...
public interface MultiscaleImage {
    ...
    default List<String> getAxisNames() throws ZarrException {
        ...
        for (dev.zarr.omezarr.metadata.Axis axis : entry.axes) {
            names.add(axis.name);
        }
        return names;
    }
    ...
    static MultiscaleImage open(StoreHandle storeHandle) throws IOException, ZarrException {
        ...
        if (zarrJson.exists()) {
            ...
            if (attrs != null && attrs.has("ome")) {
                ...
                if (version.startsWith("0.6")) {
                    return dev.zarr.omezarr.v0_6.MultiscaleImage.openMultiscaleImage(storeHandle);
                }
                return dev.zarr.omezarr.v0_5.MultiscaleImage.openMultiscaleImage(storeHandle);
            }
        }
        ...
        if (zattrs.exists()) {
            ...
            if (root.has("multiscales")) {
                return dev.zarr.omezarr.v0_4.MultiscaleImage.openMultiscaleImage(storeHandle);
            }
        }
