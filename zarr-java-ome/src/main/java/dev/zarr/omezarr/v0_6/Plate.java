 ...
 */
public final class Plate extends OmeV3Group implements dev.zarr.omezarr.Plate {
    ...
    @Override
    public dev.zarr.omezarr.Well openWell(String rowColPath) throws IOException, ZarrException {
