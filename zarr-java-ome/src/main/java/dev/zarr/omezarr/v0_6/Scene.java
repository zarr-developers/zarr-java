...
import dev.zarr.omezarr.v0_6.metadata.SceneMetadata;
import dev.zarr.omezarr.v0_6.metadata.transform.ByDimensionCoordinateTransformation;
import dev.zarr.omezarr.v0_6.metadata.transform.BijectionCoordinateTransformation;
import dev.zarr.omezarr.v0_6.metadata.transform.CoordinateTransformation;
import dev.zarr.omezarr.v0_6.metadata.transform.GenericCoordinateTransformation;
import dev.zarr.omezarr.v0_6.metadata.transform.MapAxisCoordinateTransformation;
import dev.zarr.omezarr.v0_6.metadata.transform.SequenceCoordinateTransformation;
...
public final class Scene extends OmeV3Group {
    ...
    public static Scene openScene(@Nonnull StoreHandle storeHandle) throws IOException, ZarrException {
        ...
        dev.zarr.omezarr.v0_6.metadata.OmeMetadata omeMetadata = readOmeAttribute(
                group.metadata.attributes, storeHandle, dev.zarr.omezarr.v0_6.metadata.OmeMetadata.class);
    ...
    public static Scene createScene(
        ...
        dev.zarr.omezarr.v0_6.metadata.OmeMetadata omeMetadata =
                new dev.zarr.omezarr.v0_6.metadata.OmeMetadata("0.6", null, null, sceneMetadata);
    ...
    public SceneTransformationGraph getCoordinateTransformationGraph() {
        ...
        for (SceneReferenceResolver.ResolvedCoordinateSystem resolved : resolver.list()) {
            ...
            if (resolved.coordinateSystem.axes != null) {
                for (dev.zarr.omezarr.metadata.Axis axis : resolved.coordinateSystem.axes) {
    ...
    private static String extractPath(CoordinateTransformation transformation) {
        if (transformation instanceof dev.zarr.omezarr.v0_6.metadata.transform.ScaleCoordinateTransformation) {
            return ((dev.zarr.omezarr.v0_6.metadata.transform.ScaleCoordinateTransformation) transformation).path;
        }
        if (transformation instanceof dev.zarr.omezarr.v0_6.metadata.transform.TranslationCoordinateTransformation) {
            return ((dev.zarr.omezarr.v0_6.metadata.transform.TranslationCoordinateTransformation) transformation).path;
        }
        if (transformation instanceof dev.zarr.omezarr.v0_6.metadata.transform.IdentityCoordinateTransformation) {
            return ((dev.zarr.omezarr.v0_6.metadata.transform.IdentityCoordinateTransformation) transformation).path;
        }
        if (transformation instanceof dev.zarr.omezarr.v0_6.metadata.transform.AffineCoordinateTransformation) {
            return ((dev.zarr.omezarr.v0_6.metadata.transform.AffineCoordinateTransformation) transformation).path;
        }
        if (transformation instanceof dev.zarr.omezarr.v0_6.metadata.transform.RotationCoordinateTransformation) {
            return ((dev.zarr.omezarr.v0_6.metadata.transform.RotationCoordinateTransformation) transformation).path;
        }
        if (transformation instanceof dev.zarr.omezarr.v0_6.metadata.transform.DisplacementsCoordinateTransformation) {
            return ((dev.zarr.omezarr.v0_6.metadata.transform.DisplacementsCoordinateTransformation) transformation).path;
        }
        if (transformation instanceof dev.zarr.omezarr.v0_6.metadata.transform.CoordinatesCoordinateTransformation) {
            return ((dev.zarr.omezarr.v0_6.metadata.transform.CoordinatesCoordinateTransformation) transformation).path;
        }
        if (transformation instanceof GenericCoordinateTransformation) {
