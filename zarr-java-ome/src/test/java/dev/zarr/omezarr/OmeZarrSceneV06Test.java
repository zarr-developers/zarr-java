...
public class OmeZarrSceneV06Test extends OmeZarrBaseTest {
    ...
    void openSceneAndNavigateImages() throws Exception {
        ...
        dev.zarr.omezarr.v0_6.Scene scene = dev.zarr.omezarr.v0_6.Scene.openScene(sceneHandle);
        ...
        dev.zarr.omezarr.v0_6.metadata.transform.CoordinateTransformation top =
        ...
        dev.zarr.omezarr.v0_6.MultiscaleImage image = scene.openImageNode("FCWB");
    ...
    void createAndReopenScene() throws Exception {
        ...
        dev.zarr.omezarr.metadata.Axis y = new dev.zarr.omezarr.metadata.Axis("y", "space", "micrometer");
        dev.zarr.omezarr.metadata.Axis x = new dev.zarr.omezarr.metadata.Axis("x", "space", "micrometer");

        dev.zarr.omezarr.v0_6.metadata.SceneMetadata sceneMetadata =
                new dev.zarr.omezarr.v0_6.metadata.SceneMetadata(
                        Collections.singletonList(new dev.zarr.omezarr.v0_6.metadata.transform.TranslationCoordinateTransformation(
                                "imageA#physical", ".#world", "imageA to world", Arrays.asList(1.0, 2.0), null)),
                        Collections.singletonList(new dev.zarr.omezarr.v0_6.metadata.CoordinateSystem(
                                "world", Arrays.asList(y, x)))
                );

        dev.zarr.omezarr.v0_6.Scene.createScene(root, sceneMetadata);

        dev.zarr.omezarr.v0_6.metadata.MultiscalesEntry imageAEntry =
                new dev.zarr.omezarr.v0_6.metadata.MultiscalesEntry(
                        null,
                        Collections.singletonList(new dev.zarr.omezarr.v0_6.metadata.Dataset(
                                "s0",
        ...
        dev.zarr.omezarr.v0_6.MultiscaleImage.create(root.resolve("imageA"), imageAEntry);
        ...
        dev.zarr.omezarr.v0_6.Scene reopened = dev.zarr.omezarr.v0_6.Scene.openScene(root);
        ...
        dev.zarr.omezarr.v0_6.MultiscaleImage imageA = reopened.openImageNode("imageA");
        assertEquals(1, imageA.getScaleLevelCount());
        assertArrayEquals(new long[]{16, 16}, imageA.openScaleLevel(0).metadata().shape);

        dev.zarr.omezarr.v0_6.SceneTransformationGraph graph = reopened.getCoordinateTransformationGraph();
        assertEquals(2, graph.nodes.size());
        assertEquals(1, graph.edges.size());
        assertEquals("coordinateTransformations/lens", dev.zarr.omezarr.v0_6.Scene.normalizeCoordinateTransformPath("./coordinateTransformations/lens"));
    ...
    void openSceneExample1AffinePathBetweenInstruments() throws Exception {
        dev.zarr.omezarr.v0_6.Scene scene =
                dev.zarr.omezarr.v0_6.Scene.openScene(new FilesystemStore(V06_SCENE_EXAMPLE1).resolve());
        ...
        assertTrue(ct instanceof dev.zarr.omezarr.v0_6.metadata.transform.AffineCoordinateTransformation);
        assertEquals("coordinateTransformations/sampleA_instrument2-to-instrument1",
                ((dev.zarr.omezarr.v0_6.metadata.transform.AffineCoordinateTransformation) ct).path);

        dev.zarr.omezarr.v0_6.MultiscaleImage i1 = scene.openImageNode("sampleA_instrument1");
        dev.zarr.omezarr.v0_6.MultiscaleImage i2 = scene.openImageNode("sampleA_instrument2");
    ...
    void openSceneExample2TwoAffineLinksViaInstrument2() throws Exception {
        dev.zarr.omezarr.v0_6.Scene scene =
                dev.zarr.omezarr.v0_6.Scene.openScene(new FilesystemStore(V06_SCENE_EXAMPLE2).resolve());
        ...
        dev.zarr.omezarr.v0_6.metadata.transform.CoordinateTransformation t0 =
                scene.getSceneMetadata().coordinateTransformations.get(0);
        dev.zarr.omezarr.v0_6.metadata.transform.CoordinateTransformation t1 =
        ...
        assertTrue(t0 instanceof dev.zarr.omezarr.v0_6.metadata.transform.AffineCoordinateTransformation);
        assertTrue(((dev.zarr.omezarr.v0_6.metadata.transform.AffineCoordinateTransformation) t0).affine.size() > 0);
