...
public class OmeZarrV04Test extends OmeZarrBaseTest {
    ...
    Class<?> expectedConcreteClass() {
        return dev.zarr.omezarr.v0_4.MultiscaleImage.class;
    }
    ...
    void omeroChannels() throws Exception {
        dev.zarr.omezarr.v0_4.MultiscaleImage image =
                dev.zarr.omezarr.v0_4.MultiscaleImage.openMultiscaleImage(imageStoreHandle());
    ...
    void labelsOpenLabel() throws Exception {
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_4.MultiscaleImage.class, nuclei);
    ...
    void hcsPlate() throws Exception {
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_4.Plate.class, plate);
    ...
    void hcsWellViaPlate() throws Exception {
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_4.Well.class, well);
    ...
    void hcsFullNavigation() throws Exception {
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_4.MultiscaleImage.class, fov);
    ...
    void writeCreateAndReopen() throws Exception {
        ...
        dev.zarr.omezarr.v0_4.MultiscaleImage created =
                dev.zarr.omezarr.v0_4.MultiscaleImage.create(handle, new MultiscalesEntry(axes, Collections.emptyList()));
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_4.MultiscaleImage.class, reopened);
    ...
    void writeOmeroRoundTrip() throws Exception {
        ...
        dev.zarr.omezarr.v0_4.MultiscaleImage reopened =
                dev.zarr.omezarr.v0_4.MultiscaleImage.openMultiscaleImage(handle);
    ...
    void writePlateRoundTrip() throws Exception {
        ...
        dev.zarr.omezarr.v0_4.Plate.createPlate(handle, meta);
    ...
    void openS3Idr0048AV04() throws Exception {
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_4.MultiscaleImage.class, image);
