...
import dev.zarr.omezarr.metadata.OmeroMetadata;
...
public class OmeZarrV05Test extends OmeZarrBaseTest {
    ...
    Class<?> expectedConcreteClass() {
        return dev.zarr.omezarr.v0_5.MultiscaleImage.class;
    }
    ...
    void omeroChannels() throws Exception {
        dev.zarr.omezarr.v0_5.MultiscaleImage image =
                dev.zarr.omezarr.v0_5.MultiscaleImage.openMultiscaleImage(imageStoreHandle());
    ...
    void labelsOpenLabel() throws Exception {
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_5.MultiscaleImage.class, nuclei);
    ...
    void hcsPlate() throws Exception {
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_5.Plate.class, plate);
    ...
    void hcsWellViaPlate() throws Exception {
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_5.Well.class, well);
    ...
    void hcsFullNavigation() throws Exception {
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_5.MultiscaleImage.class, fov);
    ...
    void writeCreateAndReopen() throws Exception {
        ...
        dev.zarr.omezarr.v0_5.MultiscaleImage created =
                dev.zarr.omezarr.v0_5.MultiscaleImage.create(handle, new MultiscalesEntry(axes, Collections.emptyList()));
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_5.MultiscaleImage.class, reopened);
    ...
    void writeLabelsRoundTrip() throws Exception {
        ...
        dev.zarr.omezarr.v0_5.MultiscaleImage nuclei = dev.zarr.omezarr.v0_5.MultiscaleImage.create(
    ...
    void writePlateRoundTrip() throws Exception {
        ...
        dev.zarr.omezarr.v0_5.Plate.createPlate(handle, meta);
    ...
    void writeHcsFullIntegration() throws Exception {
        ...
        dev.zarr.omezarr.v0_5.Plate.createPlate(plateHandle, new PlateMetadata(
                Collections.singletonList(new NamedEntry("1")),
                Collections.singletonList(new NamedEntry("A")),
                Collections.singletonList(new WellRef("A/1", 0, 0)),
                null, null, null, null));
        dev.zarr.omezarr.v0_5.Well.createWell(
        ...
        dev.zarr.omezarr.v0_5.MultiscaleImage fov = dev.zarr.omezarr.v0_5.MultiscaleImage.create(
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_5.MultiscaleImage.class, image);
    ...
    void openS3Idr0083V05() throws Exception {
        ...
        for (int i = 0; i < entry.datasets.size(); i++) {
            dev.zarr.omezarr.metadata.Dataset ds = entry.datasets.get(i);
