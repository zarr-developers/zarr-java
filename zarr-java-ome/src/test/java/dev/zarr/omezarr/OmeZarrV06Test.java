package dev.zarr.omezarr;

import dev.zarr.omezarr.metadata.MultiscalesEntry;
import dev.zarr.omezarr.metadata.NamedEntry;
import dev.zarr.omezarr.metadata.OmeroChannel;
import dev.zarr.omezarr.metadata.OmeroRdefs;
import dev.zarr.omezarr.metadata.OmeroWindow;
import dev.zarr.omezarr.metadata.PlateMetadata;
import dev.zarr.omezarr.metadata.WellImage;
import dev.zarr.omezarr.metadata.WellMetadata;
import dev.zarr.omezarr.metadata.WellRef;
...
public class OmeZarrV06Test extends OmeZarrBaseTest {
    ...
    Class<?> expectedConcreteClass() {
        return dev.zarr.omezarr.v0_6.MultiscaleImage.class;
    }
    ...
    void coordinateSystemsPresentInEntry() throws Exception {
        ...
        dev.zarr.omezarr.v0_6.MultiscaleImage v06Image =
                (dev.zarr.omezarr.v0_6.MultiscaleImage) image;
        dev.zarr.omezarr.v0_6.metadata.MultiscalesEntry entry = v06Image.getMultiscalesEntry(0);
    ...
    void datasetsPathsAndTransformations() throws Exception {
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_6.metadata.transform.ScaleCoordinateTransformation.class, ct);
        dev.zarr.omezarr.v0_6.metadata.transform.ScaleCoordinateTransformation scaleCt =
    ...
    void read3dAxesFromCoordinateSystems() throws Exception {
        ...
        assertInstanceOf(dev.zarr.omezarr.v0_6.MultiscaleImage.class, image);
        ...
        List<dev.zarr.omezarr.metadata.Axis> axes = entry.coordinateSystems.get(0).axes;
    ...
    void readHumanOrganAtlasOverview() throws Exception {
        ...
        dev.zarr.omezarr.v0_6.MultiscaleImage typed = (dev.zarr.omezarr.v0_6.MultiscaleImage) image;
        dev.zarr.omezarr.v0_6.metadata.MultiscalesEntry entry = typed.getMultiscalesEntry(0);
        assertNotNull(entry.coordinateSystems);
    ...
    void readV06WithOmeroMetadata() throws Exception {
        ...
        java.util.List<dev.zarr.omezarr.metadata.Axis> axes = Arrays.asList(
                new dev.zarr.omezarr.metadata.Axis("y", "space", "micrometer"),
                new dev.zarr.omezarr.metadata.Axis("x", "space", "micrometer"));
        java.util.List<dev.zarr.omezarr.v0_6.metadata.Dataset> datasets =
                java.util.Collections.singletonList(new dev.zarr.omezarr.v0_6.metadata.Dataset(
                        "s0",
                        java.util.Collections.singletonList(
                                dev.zarr.omezarr.v0_6.metadata.transform.CoordinateTransformation.scale(
                                        Arrays.asList(1.0, 1.0), "s0", "physical"))));
        dev.zarr.omezarr.v0_6.metadata.MultiscalesEntry ms =
                new dev.zarr.omezarr.v0_6.metadata.MultiscalesEntry(
                        null,
                        datasets,
                        null,
        ...
        dev.zarr.omezarr.metadata.OmeroMetadata omero =
                new dev.zarr.omezarr.metadata.OmeroMetadata(
                        1,
                        "0.5",
                        "example.tif",
        ...
        dev.zarr.omezarr.v0_6.metadata.OmeMetadata ome =
                new dev.zarr.omezarr.v0_6.metadata.OmeMetadata("0.6", java.util.Collections.singletonList(ms), omero);
        dev.zarr.zarrjava.v3.Group.create(outHandle, dev.zarr.omezarr.OmeV3Group.omeAttributes(ome));
        ...
        dev.zarr.omezarr.v0_6.MultiscaleImage read =
                (dev.zarr.omezarr.v0_6.MultiscaleImage) MultiscaleImage.open(outHandle);
    ...
    void readV06WithBioformats2rawLayout() throws Exception {
        ...
        dev.zarr.omezarr.v0_6.metadata.MultiscalesEntry ms =
                new dev.zarr.omezarr.v0_6.metadata.MultiscalesEntry(
                        ...
                        null);
        dev.zarr.omezarr.v0_6.metadata.OmeMetadata ome =
                new dev.zarr.omezarr.v0_6.metadata.OmeMetadata(
                        "0.6",
    ...
    void hcsV06PlateWellDispatchAndNavigation() throws Exception {
        ...
        dev.zarr.omezarr.v0_6.Plate.createPlate(plateHandle, new PlateMetadata(
                ...
                null, null, null, null));
        dev.zarr.omezarr.v0_6.Well.createWell(
                plateHandle.resolve("A/1"),
                new WellMetadata(Collections.singletonList(new WellImage("0", null))));

        List<dev.zarr.omezarr.metadata.Axis> axes = Arrays.asList(
                new dev.zarr.omezarr.metadata.Axis("y", "space", "micrometer"),
                new dev.zarr.omezarr.metadata.Axis("x", "space", "micrometer"));
        dev.zarr.omezarr.v0_6.metadata.MultiscalesEntry ms =
                new dev.zarr.omezarr.v0_6.metadata.MultiscalesEntry(
                        ...
                        null,
                        null);
        dev.zarr.omezarr.v0_6.MultiscaleImage fov = dev.zarr.omezarr.v0_6.MultiscaleImage.create(
        ...
        fov.createScaleLevel(
                ...
                dev.zarr.zarrjava.v3.Array.metadataBuilder()
                        ...
                        .build(),
                Collections.singletonList(dev.zarr.omezarr.metadata.transform.CoordinateTransformation.scale(
                        Arrays.asList(1.0, 1.0))));

        Plate plate = Plate.open(plateHandle);
        assertInstanceOf(dev.zarr.omezarr.v0_6.Plate.class, plate);
        assertEquals("A/1", plate.getPlateMetadata().wells.get(0).path);
        Well well = plate.openWell("A/1");
        assertInstanceOf(dev.zarr.omezarr.v0_6.Well.class, well);
